    ...
    public class PhysicCharBehaviourEditor : Editor
    {
        ...
        public void OnSceneGUI()
        {
            ...
            for (int i = 0; i < verts.Length; ++i)
            {
                ...
                var fmh_43_65_638762061937633660 = Quaternion.identity; handles[i] = Handles.FreeMoveHandle(handles[i], fHandleSize, Vector3.zero, EditorCompatibilityUtils.DotCap);
            ...
            var fmh_54_85_638762061937649432 = Quaternion.identity; vCenter = Handles.FreeMoveHandle(vCenter + myTarget.transform.position, fHandleSize, Vector3.zero, EditorCompatibilityUtils.DotCap);
